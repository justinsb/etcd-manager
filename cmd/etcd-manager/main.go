...
func expandUrls(urls string, address string) []string {
	var expanded []string
...
func RunEtcdManager(o *EtcdManagerOptions) error {
	...
	etcdNodeInfo := &apis_etcd.EtcdNode{
		...
		ClientUrls:            expandUrls(o.ClientUrls, o.Address),
		QuarantinedClientUrls: expandUrls(o.QuarantineClientUrls, o.Address),
		PeerUrls:              expandUrls(o.PeerUrls, o.Address),
	}
